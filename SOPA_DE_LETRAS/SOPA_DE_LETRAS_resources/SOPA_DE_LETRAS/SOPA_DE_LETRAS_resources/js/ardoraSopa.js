...
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"SOPA_DE_LETRAS_resources/media/i1_sistema_nervioso.jpg","");
...
ctx.fillStyle = "rgba(51,204,200,1)";ctx.quadraticCurveTo(x+w/3,y-w/3, x+w/2,y);
