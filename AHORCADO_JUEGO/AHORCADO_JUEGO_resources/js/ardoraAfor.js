...
$("#ardoraQuest").html("<img id='playSound' class='imaLeft' src='AHORCADO_JUEGO_resources/media/' alt='Sound' align='left'>"+ "<p>" + questionW[indexG] + "</p>");
...
showButtonNext();}}}}
function paintLetters(){profG=profG+94; var leV=0;var toV=profG;for (i = 0; i < fillLetter.length; i++) {
...
leV=leV+56;if (leV+56>actMaxWidth){leV=0;toV=toV+56;}}
var heiAct=(toV+56).toString()+"px";$("#ardoraAct").css("height",heiAct);
...
contexto.fillRect(0, 0, canvas.width, canvas.height);contexto.font = "60px " + fMenssage;
var metricsW = contexto.measureText(textBNext).width;var x = canvas.width - metricsW -50 ;var y = canvas.height-60-40;
...
roundedRect(contexto, x, y, metricsW+45,60+20, 5, colorButton);contexto.shadowColor = "black";contexto.shadowBlur = 15;
...
contexto.fillText(textBNext,x+10,y+60+10);contexto.lineWidth=5;contexto.stroke();contexto.fill();
